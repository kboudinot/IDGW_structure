...
## Repository for code associated with analysis of population structure and genetic diversity of Gray wolves in Idaho using single nucleotide polymorphism (SNP) and microhaplotype data generated by Genotyping-in-Thousands by sequencing (GT-seq).
